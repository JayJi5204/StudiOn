...
public class BoardEntity {
    ...
    public static BoardEntity create(Long boardId, Long userId, String nickName, String title, String content, BoardCategory boardCategory, List<String> tags) {
        ...
        boardEntity.boardCategory = boardCategory;
    ...
    public void update(String title, String content, BoardCategory boardCategory, List<String> tags) {
        this.title = title;
