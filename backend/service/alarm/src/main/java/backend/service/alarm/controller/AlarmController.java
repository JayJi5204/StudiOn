...
public class AlarmController {
    ...
    @Operation(summary = "읽지 않은 알림 개수 조회", description = "읽지 않은 알림의 총 개수를 조회합니다.")
    @GetMapping("/unread-count")
    public Long getUnreadAlarmCount(HttpServletRequest request) {
        Long userId = SecurityUtil.getCurrentUserId(request);
        return alarmService.countUnreadAlarms(userId);
    }
