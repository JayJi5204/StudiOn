...
public enum ErrorCode {
    ...
    // StudyGroup
    GROUP_NOT_FOUND(HttpStatus.NOT_FOUND, "SG001", "스터디 그룹을 찾을 수 없습니다."),
    ALREADY_MEMBER(HttpStatus.BAD_REQUEST, "SG002", "이미 가입된 멤버입니다."),
    ALREADY_PENDING(HttpStatus.BAD_REQUEST, "SG003", "이미 가입 신청 중입니다."),
    GROUP_FULL(HttpStatus.BAD_REQUEST, "SG004", "그룹 정원이 가득 찼습니다."),
    MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, "SG005", "멤버를 찾을 수 없습니다."),
    CANNOT_KICK_LEADER(HttpStatus.BAD_REQUEST, "SG006", "회장은 추방할 수 없습니다."),
    LEADER_CANNOT_LEAVE(HttpStatus.BAD_REQUEST, "SG007", "회장은 탈퇴할 수 없습니다. 회장을 위임 후 탈퇴해주세요.");
